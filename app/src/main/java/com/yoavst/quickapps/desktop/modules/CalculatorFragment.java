...
public class CalculatorFragment extends Fragment implements CompoundButton.OnCheckedChangeListener {
	...
	@AfterViews
	void init() {
		mQslide.setChecked(mPrefs.calculatorForceFloating().get());
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		switch (buttonView.getId()) {
			case R.id.qslide_checkbox:
				mPrefs.calculatorForceFloating().put(isChecked);
